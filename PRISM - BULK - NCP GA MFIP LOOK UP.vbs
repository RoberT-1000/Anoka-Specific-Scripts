...
GlobVar_path = "Q:\Blue Zone Scripts\Child Support\locally-installed-files\~globvar.vbs"									'Setting a default path, which is modified by the installer
